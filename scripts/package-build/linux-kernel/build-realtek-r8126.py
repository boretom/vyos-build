...
PACKAGE_VERSION: str = '10.015.00'
PACKAGE_DIR: str = f'{PACKAGE_NAME}-{PACKAGE_VERSION}'
SOURCES_ARCHIVE: str = 'r8126-10.015.00.tar.bz2'
SOURCES_URL: str = f'https://kupper.org/files/r8126-10.015.00.tar.bz2'
...
debmake_cmd: list[str] = [
    'debmake', '-e', 'fluffy@bunny.com', '-f', 'No Support', '-p',
